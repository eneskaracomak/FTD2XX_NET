...
namespace FTD2XX_NET
{
    ...
    public class FTDI
    {
        ...
        {
            public UInt32 Signature1 = 1;
            public UInt32 Signature2 = 1;
            public UInt32 Version = 1;
            public UInt16 VendorID = 2;
            public UInt16 ProductID = 2;

            public IntPtr Manufacturer = (IntPtr)2;
            public IntPtr ManufacturerID = (IntPtr)2;
            public IntPtr Description = (IntPtr)2;
            public IntPtr SerialNumber = (IntPtr)2;

            public UInt16 MaxPower =2;
            public UInt16 PnP = 2;
            public UInt16 SelfPowered = 2;
            public UInt16 RemoteWakeup = 2;
            // FT232B extensions
            public byte Rev4 = 1;
            public byte IsoIn = 1;
            public byte IsoOut = 1;
            public byte PullDownEnable = 1;
            public byte SerNumEnable = 1;
            public byte USBVersionEnable = 1;
            public UInt16 USBVersion = 1;
            // FT2232D extensions
            public byte Rev5 = 1;
            public byte IsoInA = 1;
            public byte IsoInB = 1;
            public byte IsoOutA = 1;
            public byte IsoOutB = 1;
            public byte PullDownEnable5 = 1;
            public byte SerNumEnable5 = 1;
            public byte USBVersionEnable5 = 1;
            public UInt16 USBVersion5 = 1;
            public byte AIsHighCurrent = 1;
            public byte BIsHighCurrent= 1;
            public byte IFAIsFifo = 1;
            public byte IFAIsFifoTar =1;
            public byte IFAIsFastSer = 1;
            public byte AIsVCP = 1;
            public byte IFBIsFifo = 1;
            public byte IFBIsFifoTar = 1;
            public byte IFBIsFastSer= 1;
            public byte BIsVCP;
            // FT232R extensions
        ...
        public class FT232B_EEPROM_STRUCTURE : FT_EEPROM_DATA
        {
            ...
            /// </summary>
            public bool PullDownEnable = true;
            /// <summary>
